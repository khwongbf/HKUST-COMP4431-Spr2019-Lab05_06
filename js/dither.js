    ...
    imageproc.dither = function(inputData, outputData, matrixType) {
		...
		switch (matrixType) {
			...
			case "bayer4":
				...
				// The following code uses Bayer's 4x4 matrix to create the
				// dithering effect. You need to extend it to work for different
				// matrix types
			...
			case "line":
				...
				// The following code uses line matrix to create the
				// dithering effect. You need to extend it to work for different
				// matrix types
			...
			case "diamond":
				...
				// The following code uses diamond matrix to create the
				// dithering effect. You need to extend it to work for different
				// matrix types
